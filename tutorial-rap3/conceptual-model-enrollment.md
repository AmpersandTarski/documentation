...
This concludes your first steps to get acquainted with Ampersand script en RAP3. The Open University Coursebook contains all theoretical background you need to start understanding and creating your own model. This Gitbook offers more practical and up to date information about the language Ampersand script. For the syntax [click here](../ampersand-syntax/). For more in depth information about modeling in Ampersand [click here](../modeling-in-ampersand/). For the rest...have a look around and feel free to ask questions.
