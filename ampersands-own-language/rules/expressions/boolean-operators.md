...
Would you like a different explanation of the boolean operators? [This page](boolean-operators-sets.md)! explains the boolean operators in terms of set theory.
