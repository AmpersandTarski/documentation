...
Would you like a different explanation of the relational operators? [This page](../rules/other-ways/relational-operators-in-set-theory.md) explains the relational operators in terms of set theory.
