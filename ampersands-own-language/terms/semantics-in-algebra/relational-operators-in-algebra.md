...
Would you like an explanation of the semantics of the relational operators? [Click here](../other-ways/relational-operators-in-set-theory.md) for an explanation in sets. [This page](../semantics-in-logic/relational-operators.md) explains the relational operators in logic.
