...
Would you like a different explanation of the primitive terms? [This page](../rules/other-ways/primitive-terms-in-set-theory.md) explains the primitive terms in terms of set theory.
