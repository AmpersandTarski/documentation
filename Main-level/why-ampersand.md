...
2. Define your information system in a [_declarative_](/../Conceptual/why-ampersand.md) language. It is not necessary to specify all business process steps, it is enough to specify the process goals.
