...
Using Ampersand allows you to communicate to the business its own jargon in order to understand its ways of working. You make your understanding explicit by writing it down in rules and interface specifications. Then, Ampersand generates a working prototype of the information system. Both you and business users may exercise this in order to validate this understanding, and the effects it has in an information system. Business users may exercise the prototype to validate your understanding as well, allowing all of you to find 'common ground'. And it saves you a lot of effort programming this stuff in software, because Ampersand will do that for you. 
