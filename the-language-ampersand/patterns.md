...
|  |  |
| :--- | :--- |
| `<rule>` | a statement that declares a [rule]() |
| `<classify>` | a statement that specifies generalization/specialization of [concepts]() |
| `<relation>` | a declaration of a relation, stating the existence of a [relation](relations.md) within the context |
| `<conceptDef>` | a description of a [concept](), to document its meaning |
